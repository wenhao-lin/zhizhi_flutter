                  ...
                  child: new TextButton(
                      ...
                      child: new Container(
                        ...
                        child: new Column(
                          children: <Widget>[
                            new Container(
                              child: new Text("114", style: new TextStyle(fontSize: 16.0, color: GlobalConfig.fontColor),),
                            ),
                            new Container(
                  ...
                  child: new TextButton(
                      ...
                      child: new Container(
                        ...
                        child: new Column(
                          children: <Widget>[
                            new Container(
                              child: new Text("22", style: new TextStyle(fontSize: 16.0, color: GlobalConfig.fontColor),),
                            ),
                            new Container(
                    ...
                    child: new TextButton(
                        ...
                        child: new Container(
                          ...
                          child: new Column(
                            children: <Widget>[
                              new Container(
                                child: new Text("1000", style: new TextStyle(fontSize: 16.0, color: GlobalConfig.fontColor),),
                              ),
                              new Container(
